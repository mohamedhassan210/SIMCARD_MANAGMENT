...
namespace Sim_Card_Management.Migrations
{
    ...
    [Migration("20260901094455_AddServiceProviderPhonePrefixes")]
    partial class AddServiceProviderPhonePrefixes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BranchFireWallType", b =>
                {
                    b.Property<int>("BranchesId")
                        .HasColumnType("int");

                    b.Property<int>("FireWallTypesId")
                        .HasColumnType("int");

                    b.HasKey("BranchesId", "FireWallTypesId");

                    b.HasIndex("FireWallTypesId");

                    b.ToTable("BranchFireWallType");
                });
            ...
            modelBuilder.Entity("Sim_Card_Management.Models.FireWallType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sim_Card_Management.Models.RenewalType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sim_Card_Managment.Models.MailConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sim_Card_Managment.Models.ServiceProvider", b =>
                {
                    ...
                    b.Property<string>("PhonePrefixes")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("BranchFireWallType", b =>
                {
                    b.HasOne("Sim_Card_Management.Models.Branch", null)
                        .WithMany()
                        .HasForeignKey("BranchesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sim_Card_Management.Models.FireWallType", null)
                        .WithMany()
                        .HasForeignKey("FireWallTypesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Sim_Card_Management.Models.InternetLine", b =>
                {
                    ...
                    b.HasOne("Sim_Card_Management.Models.RenewalType", "RenewalType")
                        .WithMany("InternetLines")
